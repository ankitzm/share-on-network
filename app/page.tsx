      ...
      <div className="mt-14 md:mt-16 lg:mt-20">
        <form action={Upload}>
          <label htmlFor="uploadFile"
            className="bg-white backdrop-blur-sm bg-opacity-20 text-center rounded w-full sm:w-[360px] min-h-[160px] py-4 px-4 flex flex-col items-center justify-center cursor-pointer border-2 border-gray-300 border-dashed mx-auto font-[sans-serif] m-4">
          ...
          <input type="submit" value="Upload File" className="bg-white backdrop-blur-sm bg-opacity-20 p-2 font-semibold rounded w-full" />
        </form>
      </div>
